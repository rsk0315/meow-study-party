...
\begin{tikzpicture}
  ...
  data [format=named] {
    x=1e1, y=455.81e-9, set=min25
    x=1e2, y=793.14e-9, set=min25
    x=1e3, y=2.4207e-6, set=min25
    x=1e4, y=9.4495e-6, set=min25
    x=1e5, y=39.810e-6, set=min25
    x=1e6, y=189.04e-6, set=min25
    x=1e7, y=860.36e-6, set=min25
    x=1e8, y=3.6755e-3, set=min25
    ...
    x=1e1, y=26.461e-9, set=black
    x=1e2, y=190.95e-9, set=black
    x=1e3, y=961.23e-9, set=black
    x=1e4, y=5.0659e-6, set=black
    x=1e5, y=25.532e-6, set=black
    x=1e6, y=123.54e-6, set=black
    x=1e7, y=598.86e-6, set=black
    x=1e8, y=2.9926e-3, set=black
